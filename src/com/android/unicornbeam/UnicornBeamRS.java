...
public class UnicornBeamRS implements SharedPreferences.OnSharedPreferenceChangeListener {
    public static String LOG_TAG = "UnicornBeam";
    public static final int DOT_COUNT = 28;
    private Resources mRes;
    private RenderScriptGL mRS;
    private ScriptC_unicornbeam mScript;
    int mHeight;
    int mWidth;
    ...
    public void init(Context context, int dpi, RenderScriptGL rs,
        ...
        if (!mInited) {
            mDensityDPI = dpi;
            mContext = context;
            mSharedPref = mContext.getSharedPreferences(UnicornBeamSelector.KEY_PREFS,
            ...
            mScript = new ScriptC_unicornbeam(mRS, mRes, R.raw.unicornbeam);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(UnicornBeamSelector.KEY_ENABLED)) {
            loadTextures();
        }
        makeNewState();
    }
    ...
    private void makeNewState() {
        Float3 adjust;
        if (mSharedPref.getBoolean(UnicornBeamSelector.KEY_ENABLED,
                    mRes.getBoolean(R.bool.recolor_enabled))) {
            adjust = new Float3(
                    mSharedPref.getFloat(UnicornBeamSelector.KEY_HUE,
                        Float.valueOf(mRes.getString(R.string.hue))),
                    mSharedPref.getFloat(UnicornBeamSelector.KEY_SATURATION,
                        Float.valueOf(mRes.getString(R.string.saturation))),
                    mSharedPref.getFloat(UnicornBeamSelector.KEY_BRIGHTNESS,
    ...
    private void loadTextures() {
        boolean recolor = mSharedPref.getBoolean(UnicornBeamSelector.KEY_ENABLED, false);
