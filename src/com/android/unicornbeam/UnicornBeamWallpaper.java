...
public class UnicornBeamWallpaper extends WallpaperService {
    ...
    private class RenderScriptEngine extends Engine {
        ...
        private UnicornBeamRS mWallpaperRS = null;
        ...
        public void onSurfaceCreated(SurfaceHolder surfaceHolder) {
            ...
            mRenderScript = new RenderScriptGL(UnicornBeamWallpaper.this, sc);
        ...
        public void onSurfaceChanged(SurfaceHolder surfaceHolder, int format, int width,
            ...
            if (mWallpaperRS == null) {
                mWallpaperRS = new UnicornBeamRS();
                mWallpaperRS.init(UnicornBeamWallpaper.this, mDensityDPI,
